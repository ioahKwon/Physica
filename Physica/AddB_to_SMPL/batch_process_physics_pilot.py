...
def main():
    ...
    parser.add_argument('--physics_grf_weight', type=float, default=0.1,
    ...
    parser.add_argument('--physics_contact_weight', type=float, default=0.02,
    ...
    config = OptimisationConfig(
        ...
        physics_grf_weight=args.physics_grf_weight,
        physics_com_weight=args.physics_com_weight,
        physics_contact_weight=args.physics_contact_weight
    )
    ...
    print(f"    - GRF weight: {args.physics_grf_weight}")
    print(f"    - CoM weight: {args.physics_com_weight}")
    print(f"    - Contact weight: {args.physics_contact_weight}")
    print()
    ...
    with open(summary_file, 'w') as f:
        json.dump({
            ...
            'physics_weights': {
                'grf': args.physics_grf_weight,
                'com': args.physics_com_weight,
                'contact': args.physics_contact_weight
            },
