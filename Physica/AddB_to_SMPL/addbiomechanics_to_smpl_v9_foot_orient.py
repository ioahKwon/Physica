...
# -*- coding: utf-8 -*-
"""
AddBiomechanics (.b3d) → SMPL parameter fitting - v9_foot_orient.

This version (v9_foot_orient) adds FIX 9 to address foot orientation issues:
...
FIX 9: **FOOT ORIENTATION LOSS** (NEW!)
    ...
    - Applied to all optimization stages with weight 1.0
...
def main() -> None:
    ...
    run_name = "v9_foot_orient_" + run_name
