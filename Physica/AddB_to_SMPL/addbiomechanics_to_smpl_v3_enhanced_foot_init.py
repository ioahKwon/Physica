...
# -*- coding: utf-8 -*-
"""
AddBiomechanics (.b3d) → SMPL parameter fitting - v3_enhanced + Foot Initialization.

This version (v3_enhanced_foot_init) adds CRITICAL FIX to v3_enhanced:
...
v3_enhanced_foot_init NEW CRITICAL FIX:
    **FOOT ROTATION INITIALIZATION** from AddBiomechanics data

Problem diagnosed:
    - Foot rotations were [0, 0, 0] in ALL frames (not optimized)
    - Weak gradient + pose regularization → foot stuck at 0°
    - Visual issue: feet appear in wrong orientation
...
Expected improvements:
    - Foot rotation ≠ 0° (actually optimized!)
