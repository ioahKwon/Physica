#!/usr/bin/env python3
"""
Render SMPL joints from FIXED coordinate version as video
"""
...
def main():
    ...
    output_path = '/egr/research-zijunlab/kwonjoon/smpl_joints_p020_analytical_foot.mp4'

    print("SMPL Analytical Foot joint 비디오 생성 중...")
