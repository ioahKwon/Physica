#!/usr/bin/env python3
"""
Render SMPL skeleton only video from P020 analytical foot results (original sample)
Using FIX 5 Option 1 results
"""
...
def main():
    # Use FIX 5 Option 1 result (same P020 sample as smpl_joints_p020_analytical_foot.mp4)
    ...
    output_path = '/egr/research-zijunlab/kwonjoon/smpl_skeleton_v5_option1_p020_same_sample.mp4'

    print("=" * 80)
    print("FIX 5 Option 1 - P020 Skeleton Video (Same Sample)")
    print("=" * 80)
    ...
    for i in range(len(joints)):
        ...
        cv2.putText(img, f'MPJPE: 29.63mm (P020_split0)', (10, 110),
