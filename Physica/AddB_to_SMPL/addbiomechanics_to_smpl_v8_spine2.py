...
AUTO_JOINT_NAME_MAP: Dict[str, str] = {
    ...
    # FIX 8 (v8_spine2): RESTORE spine mapping to spine2
    # Analysis showed AddB 'back' is 10.6cm ABOVE pelvis (not below!)
    # 3D distance to spine2: 16.2cm (closest match, 61% of frames)
    # This provides crucial upper body supervision to prevent forward lean
    'back': 'spine2',
    'torso': 'spine2',
    'spine': 'spine2',
