...
AUTO_JOINT_NAME_MAP: Dict[str, str] = {
    ...
    # FIX 7 (v7): REMOVED spine mapping - AddB 'back' joint is below pelvis, not spine
    # 'back': REMOVED - position is below pelvis (Y=-0.485m), not a spine joint
    # 'torso': REMOVED - same as 'back'
    # 'spine': REMOVED - same as 'back'
