...
# -*- coding: utf-8 -*-
"""
AddBiomechanics (.b3d) → SMPL parameter fitting - Foot Orientation Optimization Version.

This version (v3_foot_orientation) extends v3_enhanced with FOOT-SPECIFIC optimizations:
...
v3_enhanced features (baseline):
    ...
    5. Per-joint position weighting (3x feet, 2x ankles)
    → Achieved: ~75mm MPJPE on P020_split2

v3_foot_orientation NEW features:
    5. Joint-Specific Pose Regularization: Lower regularization for feet/ankles to allow better rotation
    6. Increased Foot Pose Learning Rate: 2x learning rate for foot pose parameters
    7. Enhanced Ankle→Foot Bone Direction Loss: 3x weight during ground contact
    8. Foot Orientation Constraints: Ensure proper plantarflexion/dorsiflexion

Problem addressed:
    - Professor feedback: "foot is toward the back" and "foot is not optimized"
    - Root cause: Foot POSITIONS were close but foot ORIENTATION (rotation angles) were wrong
    - Solution: Optimize foot POSE PARAMETERS (rotation) more aggressively

Expected improvements:
    - Foot orientation will be correct (no more "pointing backward")
    - MPJPE should maintain ~75mm or improve
    - Visual quality significantly better for feet
    - Proper foot angles during stance and swing phases
...
def main() -> None:
    ...
    run_name = "foot_orient_" + run_name
