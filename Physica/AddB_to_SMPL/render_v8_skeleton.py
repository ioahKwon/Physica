#!/usr/bin/env python3
"""
Render SMPL skeleton from FIX 8 results (spine2 and spine3 versions)
"""
...
def main():
    ...
    if args.version == 'spine2':
        ...
        output_path = '/egr/research-zijunlab/kwonjoon/smpl_skeleton_v8_spine2_p020_split5.mp4'
        title = 'FIX 8 spine2: back → spine2'
        mpjpe = 64.75
        ...
        output_path = '/egr/research-zijunlab/kwonjoon/smpl_skeleton_v8_spine3_p020_split5.mp4'
        title = 'FIX 8 spine3: back → spine3'
        mpjpe = 66.18
        ...
        output_path = '/egr/research-zijunlab/kwonjoon/smpl_skeleton_v9_p020_split5.mp4'
        title = 'FIX 9: foot orientation loss'
        mpjpe = 90.53
    else:  # v10
        smpl_params_path = '/tmp/v10_foot_orient_late_p020_split5/v10_foot_orient_late_with_arm_carter2023_p020/smpl_params.npz'
        output_path = '/egr/research-zijunlab/kwonjoon/smpl_skeleton_v10_p020_split5.mp4'
        title = 'FIX 10: foot orient loss (late-stage)'
        mpjpe = 83.80

    smpl_model_path = '/egr/research-zijunlab/kwonjoon/Code/Physica/AddB_to_SMPL/models/smpl_model.pkl'

    print("=" * 80)
    print(f"FIX 8 ({args.version}) - P020_split5 Skeleton Video")
    print("=" * 80)
