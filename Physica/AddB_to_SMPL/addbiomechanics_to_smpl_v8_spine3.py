...
AUTO_JOINT_NAME_MAP: Dict[str, str] = {
    ...
    # FIX 8 (v8_spine3): RESTORE spine mapping to spine3
    # Alternative mapping: spine3 is upper back, closer to shoulders
    # May provide better shoulder positioning constraint
