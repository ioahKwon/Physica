...
AUTO_JOINT_NAME_MAP: Dict[str, str] = {
    ...
    'back': 'spine2',  # FIX 5 (v5 Option 2): Map to spine2 instead of spine1
    'torso': 'spine1',
    'spine': 'spine1',
...
def convert_addb_to_smpl_coords(joints: np.ndarray) -> np.ndarray:
    # AddBiomechanics already uses Y-up coordinate system (same as SMPL)
...
class OptimisationConfig:
    ...
    # FIX 5 (v5 Option 2): Spine vertical constraint
        ...
        for iter_idx in range(num_iters):
            ...
            if (iter_idx + 1) % 10 == 0:
                print(f'    Iter {iter_idx+1}/{num_iters}: Loss={total_loss.item():.6f}, '
                      ...
                      f'Spine={spine_vertical_loss.item():.6f}, Ankle={ankle_limit_loss.item():.6f}')
